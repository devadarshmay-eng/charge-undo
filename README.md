...
EVUndo bypasses centralized, slow-to-update operator APIs. Instead, it places verification in the hands of the drivers themselves. 
...
A key part of building EVUndo was deciding what *not* to build. These choices were deliberate design decisions aimed at maximizing speed, usability, and data integrity:
...
- **No Automatic Owner Alerts:** We do not automatically notify station operators when their chargers are flagged. This prevents bad-faith spamming of small business owners and ensures that EVUndo remains a dedicated community resource first.

## Data Sources & The Precision Caveat
EVUndo compiles its baseline directory from open-source maps, crowd directories, and public utility listings. 
